...
export default function ProductSection() {
  return (
    <section
      id="produk"
     className="relative overflow-hidden py-28 bg-linear-to-b from bg-[var(--beige)] via-[--beige] to-[var(--bg-primary)]"
...
quality={85}
      ...
      >
        ...
        <h3
          className="text-5xl font-bold text-(--coffee) leading-tight"
          style={{
            fontFamily: "Georgia, 'Times New Roman', serif",
          }}
        >
