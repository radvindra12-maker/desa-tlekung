...
const VIDEO_ID = "MNx4uBslCtI"; // ← ID dari URL YouTube
...
const fakta = [
  ...
  { value: "5", label: "Generasi Penerus" },
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
         ...
         <div className="inline-flex items-center gap-2 mb-5">
          ...
          <h2
            className="text-3xl sm:text-4xl lg:text-5xl font-extrabold  text-(--cream) tracking-tight leading-tight mb-11"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-10">
          ...
          >
            ...
            <p className="mt-3 text-xs text-stone-700 pl-3">
        ...
        >
          <a
            href={`https://www.youtube.com/watch?v=MNx4uBslCtI${VIDEO_ID}`}
            target="_blank"
