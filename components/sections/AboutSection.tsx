...
quality={85}
            ...
            <div className="absolute -bottom-5 -left-5 bg-(--cream) dark:bg-gray-900 p-4 rounded-2xl shadow-xl">
          ...
          >
            ...
            >
              {miniStats.map((stat, index) => (
                <div
                  key={index}
                  className="text-center p-4 rounded-2xl bg-(--cream) dark:bg-gray-900"
                >
                  <div className="text-2xl font-bold text-[var(--coffee)]">
                    {stat.value}
                  </div>
